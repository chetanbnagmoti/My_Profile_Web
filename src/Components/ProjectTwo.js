...
const projects = [
  {
    ...
    link: "https://binnysjewellery.com/",
    description:
    ...
    imageUrl: "https://binnysjewellery.com/images/Mumbai_Map.png",
  },
  {
    id: 2,
    title: "Airline Reservation System",
    skills:
      "Node.js ,Express.js ,Moongodb , React JS, Bootstrap, Email.js and Axios",
    duration: "Sep 2022 to Mar 2023",
    link: "https://github.com/chetanbnagmoti/Air_System_Backend",
    description:
...

  {
    ...
    skills:
      "Node.js, React.js, Express.js, MongooDB, Socket.io, Nodemailer, RazorPay",
  ...
  },
  {
    ...
    title: "Weather_App",
    skills:
      "HTML, CSS, Bootstrap, and JavaScript. It leverages a third-party OpenWeatherMap API to provide real-time weather information to users.",
    duration: "Sep 2022 to Mar 2023",
  ...
  },
  {
    ...
    skills:
      "React.js, Node.js, Express.js, Material UI, MSG-91, Nodemailer, Bootstrap",
    duration: "2023 Aug To Present",
    // link: "http://businessportal.saveeat.in/",
    description:
      "This dashboard is used by restaurants to manage their brand. It allows restaurants to add their products, manage choices, apply discounts, and more.",
    imageUrl: brand,
  },
  ...
  return (
    <>
      <div className="col-lg-12 text-center resume mb-5">
        ...
        <p>
          Below are the sample Data Analytics projects on Spring Boot, Java,
          API, Node.js, React.js, Express.js, Mongoo-Db, My-SQL, HTML, CSS.
        </p>
              ...
              >
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text text-muted text-left mt-2">
                      Skill Used:- {project.skills}
                    </p>
                  </div>
                </div>
              </div>
